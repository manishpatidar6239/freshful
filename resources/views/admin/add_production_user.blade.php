        ...
        <div class="col-md-12">
          <div class="section-content">
            <div class="content-head">
              <h4 class="content-title">Add Production User</h4><!-- /.content-title -->
            ...
            <div class="content-details show">
              <div id="pay-invoice" class="card pay-invoice">
                <div class="card-body">
                  <form class="" id="view_production_user_form" name="view_production_user_form" action="ajax/add_production_user.php" onsubmit="return false;" method="post" novalidate="novalidate">
