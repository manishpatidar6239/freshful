        ...
        <div class="col-md-12">
          <div class="section-content">
            <div class="content-head">
              <h4 class="content-title">Add Account manager</h4><!-- /.content-title -->
            ...
            <div class="content-details show">
              <div id="pay-invoice" class="card pay-invoice">
                <div class="card-body">
                  <form class="" id="view_account_manager_form" name="view_account_manager_form" action="ajax/add_account_manager.php" onsubmit="return false;" method="post" novalidate="novalidate">
