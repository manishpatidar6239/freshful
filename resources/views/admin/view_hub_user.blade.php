        ...
        <div class="col-md-12">
          <div class="section-content">
            <div class="content-head">
              <h4 class="content-title">View HUB User</h4><!-- /.content-title -->
            ...
            <div class="content-details show">
              <div id="pay-invoice" class="card pay-invoice">
                <div class="card-body">
                  <form class="" id="view_hub_user_form" name="view_hub_user_form" action="ajax/update_hub_user.php" onsubmit="return false;" method="post" novalidate="novalidate">
                    ...
                    <div class="row form-group">
                      ...
                      <div class="col-12 col-md-9">
                        <select name="hub_id" class="form-control select2 select2-hidden-accessible" data-select2-id="select2-data-1-8g75" tabindex="-1" aria-hidden="true">
                          ...
                          <option value="27" selected="" data-select2-id="select2-data-3-iooe">VNB</option>
                          <option value="32">VRN</option>
                          <option value="33">Fort</option>
                          <option value="34">TJR</option>
                          <option value="35">WAD</option>
                        </select><span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="select2-data-2-954w" style="width: 562.273px;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-hub_id-av-container" aria-controls="select2-hub_id-av-container"><span class="select2-selection__rendered" id="select2-hub_id-av-container" role="textbox" aria-readonly="true" title="VNB">VNB</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                      </div>
                    </div>
                    ...
                    <div class="card-footer">
                      ...
                      <!--<button type="reset" id="delete_hub_user" class="btn btn-danger btn-sm">
