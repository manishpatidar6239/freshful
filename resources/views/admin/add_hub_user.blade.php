        ...
        <div class="col-md-12">
          <div class="section-content">
            <div class="content-head">
              <h4 class="content-title">Add HUB User</h4><!-- /.content-title -->
            ...
            <div class="content-details show">
              <div id="pay-invoice" class="card pay-invoice">
                <div class="card-body">
                  <form class="" id="view_hub_user_form" name="view_hub_user_form" action="ajax/add_hub_user.php" onsubmit="return false;" method="post" novalidate="novalidate">
                    ...
                    <div class="row form-group">
                      ...
                      <div class="col-12 col-md-9">
                        <select name="hub_id" class="form-control select2 select2-hidden-accessible" data-select2-id="select2-data-1-8gm0" tabindex="-1" aria-hidden="true">
                          <option value="0" data-select2-id="select2-data-3-hip0">Select HUB</option>
                        ...
                        </select><span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="select2-data-2-g4y9" style="width: 562.273px;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-disabled="false" aria-labelledby="select2-hub_id-34-container" aria-controls="select2-hub_id-34-container"><span class="select2-selection__rendered" id="select2-hub_id-34-container" role="textbox" aria-readonly="true" title="Select HUB">Select HUB</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                      </div>
                    </div>
