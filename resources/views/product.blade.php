                    ...
                    <div class="col-sm-6">
                        <div class="d-flex justify-content-end align-items-center gap-sm-4 gap-2">
                            <div class="d-flex justify-content-start align-items-center gap-1">
                                <img src="{{ asset('assets/image/other/br1.png') }}" alt="weight" class="img-fluid ">
                                <p class="m-0 fs-7 text-nowrap"> No Preservatives</p>
                            </div>
                            <div class="d-flex justify-content-start align-items-center gap-1">
                                <img src="{{ asset('assets/image/other/br2.png') }}" alt="weight" class="img-fluid ">
                                <p class="m-0 fs-7 text-nowrap"> No Chemicals</p>
                            </div>
                            <div class="d-flex justify-content-start align-items-center gap-1">
                                <img src="{{ asset('assets/image/other/br3.png') }}" alt="weight" class="img-fluid ">
                                <p class="m-0 fs-7 text-nowrap"> Anti-Biotic Free</p>
                            </div>
                        </div>
                    </div>
